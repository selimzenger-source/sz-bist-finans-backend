...
def tweet_kap_news(
    ...
    try:
        ...
        # Flash banner KALDIRILDI — kullanici tek tutarli format istiyor.
...
def tweet_opening_summary(stocks: list) -> bool:
    ...
    try:
        ...
        text = (
            ...
            + "\n".join(lines) + "\n\n"
            f"#halkaarz"  # ticker'lar zaten satırlarda; X kuralı: hashtag yığını YOK
        )
...
def tweet_spk_application(company_name: str) -> bool:
    ...
    try:
        ...
        # Sadece hashtag ekle — linkler yok (daha temiz görünüm)
        text = text + "\n\n#halkaarz #SPK"
